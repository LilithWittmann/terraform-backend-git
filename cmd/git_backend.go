...
import (
	...
	"github.com/LilithWittmann/terraform-backend-git/cmd/discovery"
	"github.com/LilithWittmann/terraform-backend-git/server"

	_ "github.com/LilithWittmann/terraform-backend-git/storages/git" // force it to init
)
